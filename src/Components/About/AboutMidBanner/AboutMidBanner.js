        ...
        <Box>
            <Container sx={{ my: 2 }}>
                ...
                <Grid container spacing={2} >
                    ...
                    <Grid md={6} xs={12}>
                        <Typography className="text" sx={{ mt: 4, ml: 3 }}>WELCOME TO FIZXILA</Typography>
                        <Typography className="text" sx={{ ml: 4 }} variant="h4">Fizxila - We're Here To Help</Typography>
                        <Typography sx={{ ml: 4 }} variant="h4">You Repair Service</Typography>
                        <Box sx={{ mt: 5 }}>
                            <Grid container spacing={0}>
                                <Grid item xs={2}>
                                    < ArticleIcon className="text" sx={{ width: 50, height: 50, mt: 2, ml: 3 }} />
                                </Grid>
                                <Grid item xs={10}>
